...
function Login() {
  ...
  return (
    <>
      <div className='d-flex align-items-center justify-content-center' style={{ height: "100vh", backgroundColor: "#DEDEDE" }} >
        <form style={{
          minWidth: "25%",
          margin: "0 auto"
        }} onSubmit={(values) => {
          ...
          <button type="submit" className="btn btn-primary" disabled={!formik.isValid}>Login</button> {loading ? <img src={loads} alt="load" style={{width:"3rem",paddingLeft:"10px"}} />: null}
